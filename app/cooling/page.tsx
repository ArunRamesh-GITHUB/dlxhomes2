...
export const metadata: Metadata = {
  title: "Home Cooling Assessment — DLX ROI",
  description:
    "Register your interest in a home cooling assessment. We assess whether AC, a heat pump, or passive improvements are the right answer for your property.",
};
              ...
              <ul className="space-y-3">
                {checkItems.map((item) => (
                  <li key={item} className="flex gap-3 items-start">
                    <CheckCircle2 size={14} className="text-dlx-gold flex-shrink-0 mt-0.5" />
